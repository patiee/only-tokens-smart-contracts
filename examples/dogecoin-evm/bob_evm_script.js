...
async function main() {
    ...
    // Load transaction data from Alice's Dogecoin HTCL
    let dogecoinData;
    try {
    ...
    // Extract data from Dogecoin HTCL
    const hashlockEVM = dogecoinData.hashlockEVM;
    const timelock = dogecoinData.timelock;
    const aliceAddress = dogecoinData.creator;
    const bobAddress = dogecoinData.recipient;
    const amount = dogecoinData.amount;
    ...
    const evmData = {
        secret: dogecoinData.secret,
        hashlock: hashlockEVM,
        hashlockDogecoin: dogecoinData.hashlock,
        timelock: timelock,
        htclAddress: htclAddress,
        aliceAddress: alice.address,
        bobAddress: bob.address,
        amount: ethers.formatEther(htclAmount),
        dogecoinHtclAddress: dogecoinData.htclAddress
    };
