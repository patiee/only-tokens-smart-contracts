...
function generateSecretAndHashlock() {
    ...
    return {
        ...
        hashlockString: hashlock // For Dogecoin (string format)
    };
}
 ...
 * @returns {string} Hashlock in Dogecoin format (hex string without 0x)
 */
 ...
 * @param {string} dogecoinHashlock - Hashlock in Dogecoin format (hex string)
...
if (require.main === module) {
    ...
    console.log('Hashlock (Dogecoin):', hashlockString);
    ...
    console.log('\nFormat conversion:');
    console.log('EVM to Dogecoin:', evmToDogecoinHashlock(hashlock));
    console.log('Dogecoin to EVM:', dogecoinToEvmHashlock(hashlockString));
} 