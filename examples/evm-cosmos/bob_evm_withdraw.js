...
async function main() {
    ...
    // Check if Alice has already withdrawn on Cosmos
    if (!cosmosData.aliceWithdrawn) {
        console.error('❌ Error: Alice has not withdrawn from Cosmos yet');
        console.log('Alice must withdraw from Cosmos first');
        return;
    }
    console.log('✅ Alice has withdrawn from Cosmos');
    ...
    try {
        ...
        console.log('  2. Bob created HTCL on Cosmos');
        console.log('  3. Alice withdrew from Cosmos with secret');
